var app = (function () {
    ...
    // (124:4) {#each messages as message}
    function create_each_block(ctx) {
    	let div;
    	let li;
    	let t0_value = /*message*/ ctx[3].text + "";
    	let t0;
    	let li_class_value;
    	let li_transition;
    	let t1;
    	...
    	return {
    		c() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr(li, "class", li_class_value = `messageBubble-${/*message*/ ctx[3].received ? "left" : "right"}`);
    		...
    		p(ctx, dirty) {
    			if ((!current || dirty & /*messages*/ 1) && t0_value !== (t0_value = /*message*/ ctx[3].text + "")) set_data(t0, t0_value);

    			if (!current || dirty & /*messages*/ 1 && li_class_value !== (li_class_value = `messageBubble-${/*message*/ ctx[3].received ? "left" : "right"}`)) {
    ...
    function create_fragment(ctx) {
    	...
    	let p1;
    	let t8;
    	let t9_value = (/*numOfUsers*/ ctx[1] == 1 ? "is" : "are") + "";
    	let t9;
    	let t10;
    	let t11;
    	let t12;
    	let t13_value = (/*numOfUsers*/ ctx[1] == 1 ? "user" : "users") + "";
    	let t13;
    	let t14;
    	let current;
    	let mounted;
    	...
    	return {
    		c() {
    			...
    			t9 = text(t9_value);
    			t10 = space();
    			t11 = text(/*numOfUsers*/ ctx[1]);
    			t12 = space();
    			t13 = text(t13_value);
    			t14 = text(" currently chatting!");
    			attr(ul, "id", "messages");
    			...
    			attr(form, "action", "");
    			attr(p0, "id", p0_id_value = /*isTyping*/ ctx[2] ? "typing" : "noTyping");
    			attr(p1, "id", "numUsers");
    		},
    		m(target, anchor) {
    			...
    			append(form, span);
    			append(span, input);
    			set_input_value(input, /*message*/ ctx[3]);
    			append(span, t2);
    			append(span, button);
    			...
    			if (!mounted) {
    				dispose = [
    					listen(window, "unload", /*emitUserDisconnect*/ ctx[4]),
    					listen(input, "input", /*input_input_handler*/ ctx[7]),
    					listen(input, "input", /*displayLabel*/ ctx[5]),
    					listen(button, "click", prevent_default(/*sendMsg*/ ctx[6]))
    				];
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*message*/ 8 && input.value !== /*message*/ ctx[3]) {
    				set_input_value(input, /*message*/ ctx[3]);
    			}

    			if (!current || dirty & /*isTyping*/ 4 && p0_id_value !== (p0_id_value = /*isTyping*/ ctx[2] ? "typing" : "noTyping")) {
    				attr(p0, "id", p0_id_value);
    			}

    			if ((!current || dirty & /*numOfUsers*/ 2) && t9_value !== (t9_value = (/*numOfUsers*/ ctx[1] == 1 ? "is" : "are") + "")) set_data(t9, t9_value);
    			if (!current || dirty & /*numOfUsers*/ 2) set_data(t11, /*numOfUsers*/ ctx[1]);
    			if ((!current || dirty & /*numOfUsers*/ 2) && t13_value !== (t13_value = (/*numOfUsers*/ ctx[1] == 1 ? "user" : "users") + "")) set_data(t13, t13_value);
    		},
    		i(local) {
    			if (current) return;
    ...
    */
    	function displayLabel() {
    		$$invalidate(2, isTyping = message == "" ? false : true);
    	}
    	...
    	function sendMsg() {
    		...
    		$$invalidate(3, message = message.trim());
