var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if ((!current || dirty & /*messages*/ 1) && t_value !== (t_value = /*message*/ ctx[2] + "")) set_data(t, t_value);
    		},
    		i(local) {
    			if (current) return;
    ...
    function create_fragment(ctx) {
    	...
    	let p;
    	let t9;
    	let t10_value = (/*numOfUsers*/ ctx[1] == 1 ? "is" : "are") + "";
    	let t10;
    	let t11;
    	let t12;
    	let t13;
    	let t14_value = (/*numOfUsers*/ ctx[1] == 1 ? "user" : "users") + "";
    	let t14;
    	let t15;
    	let current;
    	let mounted;
    	...
    	return {
    		c() {
    			...
    			t10 = text(t10_value);
    			t11 = space();
    			t12 = text(/*numOfUsers*/ ctx[1]);
    			t13 = space();
    			t14 = text(t14_value);
    			t15 = text(" currently chatting!");
    			attr(li0, "class", "messageBubble");
    			attr(li1, "class", "messageBubble");
    			attr(ul, "id", "messages");
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(button, "click", prevent_default(/*sendMsg*/ ctx[4]))
    				];
    		...
    		p(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*numOfUsers*/ 2) && t10_value !== (t10_value = (/*numOfUsers*/ ctx[1] == 1 ? "is" : "are") + "")) set_data(t10, t10_value);
    			if (!current || dirty & /*numOfUsers*/ 2) set_data(t12, /*numOfUsers*/ ctx[1]);
    			if ((!current || dirty & /*numOfUsers*/ 2) && t14_value !== (t14_value = (/*numOfUsers*/ ctx[1] == 1 ? "user" : "users") + "")) set_data(t14, t14_value);
    		},
    		i(local) {
    			if (current) return;
    ...
    */
    	...
    	function sendMsg() {
    		...
    		$$invalidate(0, messages = messages.concat(messageString));
