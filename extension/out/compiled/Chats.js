var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if ((!current || dirty & /*messages*/ 1) && t0_value !== (t0_value = /*message*/ ctx[2] + "")) set_data(t0, t0_value);
    		},
    		i(local) {
    			if (current) return;
    ...
    function create_fragment(ctx) {
    	...
    	let p;
    	let t5;
    	let t6_value = (/*numOfUsers*/ ctx[1] == 1 ? "is" : "are") + "";
    	let t6;
    	let t7;
    	let t8;
    	let t9;
    	let t10_value = (/*numOfUsers*/ ctx[1] == 1 ? "user" : "users") + "";
    	let t10;
    	let t11;
    	let current;
    	let mounted;
    	...
    	return {
    		c() {
    			...
    			t6 = text(t6_value);
    			t7 = space();
    			t8 = text(/*numOfUsers*/ ctx[1]);
    			t9 = space();
    			t10 = text(t10_value);
    			t11 = text(" currently chatting!");
    			attr(ul, "id", "messages");
    		...
    		p(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*numOfUsers*/ 2) && t6_value !== (t6_value = (/*numOfUsers*/ ctx[1] == 1 ? "is" : "are") + "")) set_data(t6, t6_value);
    			if (!current || dirty & /*numOfUsers*/ 2) set_data(t8, /*numOfUsers*/ ctx[1]);
    			if ((!current || dirty & /*numOfUsers*/ 2) && t10_value !== (t10_value = (/*numOfUsers*/ ctx[1] == 1 ? "user" : "users") + "")) set_data(t10, t10_value);
    		},
    		i(local) {
    			if (current) return;
